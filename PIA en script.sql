USE [master]
GO
/****** Object:  Database [bdMuebleria]    Script Date: 28/10/2018 02:10:45 p. m. ******/
CREATE DATABASE [bdMuebleria]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'bdMuebleria', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\bdMuebleria.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'bdMuebleria_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\bdMuebleria_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
ALTER DATABASE [bdMuebleria] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [bdMuebleria].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [bdMuebleria] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [bdMuebleria] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [bdMuebleria] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [bdMuebleria] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [bdMuebleria] SET ARITHABORT OFF 
GO
ALTER DATABASE [bdMuebleria] SET AUTO_CLOSE ON 
GO
ALTER DATABASE [bdMuebleria] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [bdMuebleria] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [bdMuebleria] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [bdMuebleria] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [bdMuebleria] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [bdMuebleria] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [bdMuebleria] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [bdMuebleria] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [bdMuebleria] SET  ENABLE_BROKER 
GO
ALTER DATABASE [bdMuebleria] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [bdMuebleria] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [bdMuebleria] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [bdMuebleria] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [bdMuebleria] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [bdMuebleria] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [bdMuebleria] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [bdMuebleria] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [bdMuebleria] SET  MULTI_USER 
GO
ALTER DATABASE [bdMuebleria] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [bdMuebleria] SET DB_CHAINING OFF 
GO
ALTER DATABASE [bdMuebleria] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [bdMuebleria] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [bdMuebleria] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [bdMuebleria] SET QUERY_STORE = OFF
GO
USE [bdMuebleria]
GO
/****** Object:  Table [dbo].[Departamento]    Script Date: 28/10/2018 02:10:46 p. m. ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Articulo]    Script Date: 28/10/2018 02:10:47 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Vista_Articulo_Depto]    Script Date: 28/10/2018 02:10:47 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Estado]    Script Date: 28/10/2018 02:10:47 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Direccion]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Cliente]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Vista_Clientes_Edo]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Proveedor]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Vista_Prov_Articulo]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Empleado]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Vista_Empleado_Ingreso]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ListadePrecios]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Vista_Articulo_Precio]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Area_Trabajo]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CodigoPostal]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Colonia]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[DetalleVenta]    Script Date: 28/10/2018 02:10:48 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Email]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Envio]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Inventario]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MetodoEnvio]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Municipio]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Pago]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Telefono]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Turno]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Venta]    Script Date: 28/10/2018 02:10:49 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Proc_Articulo_Depto]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Proc_Articulo_Precio]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Proc_Clientes_Edo]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[Proc_Empleado_Ingreso]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Proc_Prov_Articulo]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [dbo].[trigger_nuevo_articulo]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[trigger_nuevo_articulo]
on [dbo].[Articulo]
after INSERT
as
begin
insert into new_art (id_articulo, Descripcion, id_depto, id_prov)
select id_articulo, Descripcion, id_depto, id_prov
from inserted
end
GO
ALTER TABLE [dbo].[Articulo] ENABLE TRIGGER [trigger_nuevo_articulo]
GO
/****** Object:  Trigger [dbo].[trigger_empleado_borrado]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[trigger_empleado_borrado]
  on [dbo].[Inventario]
  after DELETE
  as
  begin
     if UPDATE(Cantidad)
	 begin
	 insert into stock (clave, id_articulo, cantidad)
	 select clave, id_articulo, cantidad 
	 from inserted
	end
end
GO
ALTER TABLE [dbo].[Inventario] ENABLE TRIGGER [trigger_empleado_borrado]
GO
/****** Object:  Trigger [dbo].[trigger_update_cantidad]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[trigger_update_cantidad]
  on [dbo].[Inventario]
  after UPDATE
  as
  begin
...
GO
ALTER TABLE [dbo].[Inventario] ENABLE TRIGGER [trigger_update_cantidad]
GO
/****** Object:  Trigger [dbo].[trigger_delete_venta]    Script Date: 28/10/2018 02:10:51 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create trigger [dbo].[trigger_delete_venta]
on [dbo].[Venta]
instead of DELETE
as
begin
begin
insert into ventas_borradas (id_venta, fecha_hora, id_empleado, id_cliente, Subtotal, Impuesto, Total)
select id_venta, fecha_hora, id_empleado, id_cliente, Subtotal, Impuesto, Total
from deleted
end
end
GO
ALTER TABLE [dbo].[Venta] ENABLE TRIGGER [trigger_delete_venta]
GO
USE [master]
GO
ALTER DATABASE [bdMuebleria] SET  READ_WRITE 
GO
